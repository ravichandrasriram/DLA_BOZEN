...
def plot_results(start=0, stop=0, bucket='', id=()):  # from utils.utils import *; plot_results()
    ...
    if bucket:
        ...
        files = glob.glob('/content/drive/My Drive/Datasets/Results/BOZEN_RES/results*.txt') + glob.glob('../../Downloads/results*.txt')
    ...
    fig.tight_layout()
    ax[1].legend()
    fig.savefig('/content/drive/My Drive/Datasets/Results/BOZEN_RES/results.png', dpi=200)
