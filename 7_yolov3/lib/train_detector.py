...
class Detector():
    ...
    def set_fixed_params(self):
        ...
        Returns:
            None
        '''
        self.system_dict["fixed_params"]["wdir"] = '/content/drive/My Drive/Datasets/Results/BOZEN_RES/weights' + os.sep  
        ...
        self.system_dict["fixed_params"]["results_file"] = '/content/drive/My Drive/Datasets/Results/BOZEN_RES/results.txt'
    ...
    def set_hyperparams(self, optimizer="sgd", lr=0.00579, multi_scale=False, evolve=False, num_generations=2, 
        ...
        self.system_dict["params"]["weights"] = '/content/drive/My Drive/Datasets/Results/24OCT/weights/best.pt';
    ...
    def start_training(self):
        ...
        if(self.system_dict["dataset"]["val"]["status"]):
            ...
            if len(n):
                ...
                os.rename('/content/drive/My Drive/Datasets/Results/BOZEN_RES/results.txt', fresults)
